      ...
      <div className="link_price_block">
        ...
        <div className="Auth_main_div">
          <div
            style={
              authNav.imageAuth
                ? { backgroundImage: `url(${authNav.imageAuth})` }
                : { backgroundImage: `url(${image})` }
            }
            onClick={() => navAuth('/auth')}
            title={authNav.imageAuth ? 'Вы уже вошли в систему' : 'Войти в систему'}
        ...
        <div className="main_money_div">
          ...
          <div title="Суммарная стоимость добавленных товаров" className="price_navigation_block">
            {price} ₽
          </div>
        </div>
      </div>
