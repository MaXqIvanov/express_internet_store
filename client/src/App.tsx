...
function App() {
  ...
  const limit = 6; // число зависит от количества элементов, которые мы отображаем на одной страничке
    ...
    <div className="App">
      <Routes>
        <Route
          path="/"
          element={
            <div className="maid_div_page2">
              <Header setPage={setPage} setName={setName} setTypeGoods={setTypeGoods} />{' '}
              <StorePage
                setSort={{ setSortPrice: setSortPrice, sortPrice: sortPrice }}
                sortPrice={sortPrice}
                typeGoods={typeGoods}
                pageCount={pageCount}
                page={page}
        ...
        <Route
          ...
          element={
            <div className="maid_div_page2">
              <Header setPage={setPage} setTypeGoods={setTypeGoods} />
              <OneProodsPage index={index} /> <Footer />
            </div>
          }
        />
        <Route
        ...
        <Route
          path="/contacts"
          element={
            <Suspense fallback={<Spinner className="Spinner_contacts" animation="grow" />}>
              <div className="maid_div_page2">
                <Header setPage={setPage} setName={setName} setTypeGoods={setTypeGoods} />
                <Contacts />
              </div>
        ...
        <Route
          ...
          element={
            <Suspense fallback={<Spinner animation="grow" />}>
              <div className="maid_div_page2">
                <Header setPage={setPage} setName={setName} setTypeGoods={setTypeGoods} />
                <Questions recaptchaRef={recaptchaRef} />
              </div>
            </Suspense>
          }
        />
