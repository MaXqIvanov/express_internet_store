    ...
    <>
      {data.message ? (
        <div className={s.main}>
          <h3 title="Авторизоваться на сайте" onClick={() => nav('/auth')}>
            {data.message}
          </h3>
        </div>
      ) : (
                ...
                <div style={{ color: 'red' }}>
                  {errors.priceProods ? (
                    <span className={s.span}>
                      {errors?.priceProods?.message && errors.priceProods.message}
                    </span>
                  ) : errors.linkOnImage ? (
                    <span className={s.span}>
                      {errors?.linkOnImage?.message && errors.linkOnImage.message}
                    </span>
                  ) : errors.nameProods ? (
                    <span className={s.span}>
                      {errors?.nameProods?.message && errors.nameProods.message}
                    </span>
                  ) : (
                    ''
                  )}{' '}
