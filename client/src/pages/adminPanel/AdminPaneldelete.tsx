...
export const AdminPaneldelete = () => {
  ...
  const removeITem = (data: any) => {
    ...
    const newallprods: any = allprods.filter((elem: any) => elem.id !== data.id);
  ...
  return (
    <div>
      ...
      <div className={s.allArray}>
        {allprods.length > 0
          ? allprods.map((elem: any, index: any) => (
              <div key={index} className={s.deleteArray}>
